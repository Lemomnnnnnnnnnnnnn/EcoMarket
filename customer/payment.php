...
/* Load the order and make sure it belongs to this user and is still unpaid */
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['simulate_pay'])) {
    ...
    /* Simulation rule: a card number ending in 0000 is used to demonstrate a failed payment */
